...
if any(not d.empty for d in dataframes):
    archivo_salida = 'reporte_red_completo.xlsx'
    ...
    # --- APLICAR PERMISOS DE LECTURA Y ESCRITURA PARA TODOS ---
    try:
        # 0o666 equivale a rw-rw-rw- en Linux
        os.chmod(archivo_salida, 0o666)
        print(f"\n🚀 ¡Éxito! Reporte generado y permisos asignados a: {archivo_salida}")
    except Exception as e:
        print(f"\n⚠️ Reporte generado, pero no se pudieron cambiar los permisos: {e}")
